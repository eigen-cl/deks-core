...
test("declares the release versions and exact internal dependency closure", async () => {
  ...
  assert.deepEqual(react.dependencies, {
    ...
    "@deks-js/renderer-core": "0.4.0",
  });
  assert.equal(preview.dependencies["@deks-js/document"], "0.2.0");
  assert.equal(preview.dependencies["@deks-js/renderer-core"], "0.4.0");
  ...
  assert.equal(lock.packages["packages/react"].dependencies["@deks-js/renderer-core"], "0.4.0");
  assert.equal(lock.packages["packages/render-preview"].dependencies["@deks-js/renderer-core"], "0.4.0");
});
