...
function elementSnapshot(
  ...
  if (identity.kind === "text") return {
    ...
    horizontalAlignment: identity.horizontalAlignment!,
    verticalAlignment: identity.verticalAlignment!,
    color: state.fill!,
    overflowMode: identity.overflowMode!,
    padding: state.padding ?? { top: 0, right: 0, bottom: 0, left: 0 },
  };
